import { Github } from "lucide-react"; // Importa el ícono de GitHub
    ...
    return (
        <header className="bg-gray-900 text-white px-6 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-50 text-2xl font-normal">/</span>
                <span className="text-gray-300 text-base font-light">Profile</span>
            </div>
